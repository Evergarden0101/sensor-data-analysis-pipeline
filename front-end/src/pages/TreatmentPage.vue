<template>
    ...
    <el-row style="margin-top: 3%;margin-bottom: 3%;height:">
        ...
        <el-col :span="5" :offset="1">
            <el-row>
                <el-progress style="display:block; margin: 0 auto" type="dashboard" :percentage="patientPrecision" width="80" stroke-width="4" :color="colorsPercision" >
                    <template #default="{ percentage }">
                        <h3 class="percentage-value">{{ percentage }}%</h3>
                        <h5 class="percentage-label">Precision</h5>
                    </template>
        ...
        <el-col :span="10" :offset="1" style="height:200px">
            Other metrics...
        </el-col>
    </el-row>
